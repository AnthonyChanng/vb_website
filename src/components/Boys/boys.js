      ...
      <div className="topsection boys-section">
        <div className="container boys-container">
          <div className="flex boys-flex">
            <div className="boys-first-bar">
              <div className="imageGallery">
                <Carousel images={boysData} />
              </div>
              <div className="boys-rightSide">
                <div className="boys-description">
                  The BRHS Boys Volleyball Team are back-to-back county champs
                  as well as back-to-back North Group 4 champs. They have
                  dominated these two tournaments these past two years and look
                  to win for the third year in a row. Many players gained awards
                  for their performance throughout the season and everyone had
                  their fair share of time in the spotlight. Although there were
                  a few keys pieces who graduated last year, a large part of
                  this championship core has remained put. <br></br>
                  <br></br>The determination and strength across the team is not
                  to be underestimated. After losing the first set in the county
                  finals versus Ridge, and being down early in the last two
                  sets, it looked all but over for the Panthers. However, the
                  passion from every single player on the court shined through.
                  Play after play, the practice and knowledge that was drilled
                  into them by their coach, Corey Romanak, led them to make the
                  right decisions and the eventual victory. <br></br>
                  ...
                  winning culture, join the team! Tryouts are in late March and
                  be sure to join the Google Classroom for more information.
                </div>
                <div className="boys-awards">
                  <h1>TEAM AWARDS:</h1>
                  Harrison Fromberg: Skyland Conference Boys Volleyball Player
                  of the Year, Skyland Conference First Team, All-State Third
                  Team, and All-Group 4 First Team <br></br>Sean Marvuglio:
                  All-Group 4 Second Team and Skyland Conference First Team{" "}
                  <br></br>Matthew Dolly: Skyland Conference First Team{" "}
                  <br></br>Trevor Sullivan: Skyland Conference First Team{" "}
                  <br></br>Vihaan Pradham: Skyland Conference Second Team{" "}
                  <br></br>Cameron Willaims: Skyland Conference Second Team
            ...
            <div className="boys-players-tab">
            ...
            <div className="boys-third-bar">
              <div className="boys-coach">
                ...
                <div className="coach-description">
                  ...
                  Bridgewater-Raritan High School Boys Varsity Volleyball
                  program for over 25 years and was also the head coach of the
                  girls program before stepping down last year. Under his
                  leadership, the boys team has won two state championships and
                  multiple county tournaments. The excellent coaching ability he
                  possesses can't be underestimated. His skill and bravado push
                  his players to do their best on and off the court and the
                  level of respect that he commands from them is something that
                  only a few people can achieve.
                  <br></br>
                  <br></br>
                  As a player on the first NCAA Men's Volleyball Division III
                  National Championship team in 1997, Coach Romanak knows what
                  it takes to win, as a player and a coach. The bond that he
                  shares with each of the kids is amazing. Over the four years
                  that they are in the program, there is a close relationship
                  formed between player and coach that is very rare. All the
                  players enjoy being under his tutelage and learning from him.
                </div>
              </div>
              <div className="boys-recent-news">
                ...
                <div className="boys-news-item">
                  ...
                  Scotch Plains-Fanwood's Tim Ennis is the Boys Volleyball
