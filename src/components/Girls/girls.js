      ...
      <div className="topsection girls-section">
        <div className="container girls-container">
          <div className="flex girls-flex">
            <div className="girls-first-bar">
              ...
              <div className="girls-rightSide">
                <div className="girls-description">
                  BRHS Girls Volleyball are four time state champs as well as
                  four time Somerset County Tournament Winners. The team has
                  always been a dominant force and challengers to the
                  championship. They had a strong performance last year, making
                  it all the way to the semi-finals of the Somerset County
                  Tournament before losing to Watchung Hills. Many players were
                  recognized by the coaches across the conference and were given
                  awards based on their stellar play.<br></br> <br></br>The team
                  has a great relationship on and off the court, which speaks
                  volumes to the environment built by the coaches and past
                  players. A team bond is important to any sport and the one in
                  BRHS Girls Volleyball Program is few and far between. There's
                  a dynamic within the program that is a joy to be a part of and
                  everyone genuinely enjoys their time there. <br></br>{" "}
                  <br></br>With Coach Josh Everett at the helm, the team is an
                  amazing thing to be a part of. Winning isn't everything, even
                  though we do win a lot, the way we see it, every day is an
                  opportunity to get better. Be it a win or a loss, a practice
                  or a game, we take every day seriously and strive to grow as a
                  team and people. We encourage all girls to tryout, regardless
                  of their skill in volleyball! Tryouts are in August and be
                  sure to join the Google Classroom for extra details.{" "}
                </div>
                <div className="girls-awards">
                  <h1>TEAM AWARDS:</h1>
                  Madison Patton: All Skyland Conference Delware Divison First
                  Team <br></br>
                  Isabel Rivera: All Skyland Conference Delware Divison First
                  Team <br></br>
            ...
            <div className="girls-players-tab">
            ...
            <div id="girls-no-img">
              Some images not found because they are new to the team. Please
              wait for the season to go on for images to be taken of them.
            </div>
            <div className="girls-third-bar">
              <div className="girls-coach">
                ...
                <div className="coach-description">
                  ...
                  Before coming to BRHS as a coach, he coached girls and boys
                  club for four seasons. He then transitioned to assistant
                  varsity coach and junior varsity coach of both the girls and
                  boys program. This past season, he was promoted to head coach
                  of the girls varsity team. Before becoming a coach, Coach
                  Everett was a player at BRHS and won a state championship. He
                  also won another one as coach.
                  <br></br>
                  <br></br>
                  ...
                  will be many times when the team can just share a joke with
                  him because of his charismatic personality. The environment he
                  created is hard to come by and everyone enjoys being there
              ...
              <div className="girls-recent-news">
                ...
                <div className="girls-news-item">
                  ...
                  Girls volleyball: All-time leaders in coaching wins entering
                  2024 season
                </div>
                <div className="girls-news-item">
                  <a
